    ...
    <div className="container numerology-book-grid">
      ...
      <form className="card numerology-form" onSubmit={submit}>
       ...
       <div className="form-grid">
        ...
        <Field label="Date of Birth" name="date" value={form.date} onChange={update} placeholder="DD / MM / YYYY"/>
...
function Field({label,name,value,onChange,placeholder,type="text",required=false}){return <div className="field"><label htmlFor={name}>{label}</label><input id={name} name={name} type={type} value={value} onChange={onChange} placeholder={placeholder} required={required}/></div>}
